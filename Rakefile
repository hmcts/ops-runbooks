...
task :check_urls do
    proofer = HTMLProofer.check_directory("./build", 
        { 
            ...
            # Ignore base url that's generated by tech-docs-gem but does not exist
            :ignore_urls =>  [%r{github\.com/hmcts/(?=.*(?:pull|tree|commit))}, 'https://raw.githubusercontent.com/hmcts/ops-runbooks/master/source/search/index.html.erb']
        })
