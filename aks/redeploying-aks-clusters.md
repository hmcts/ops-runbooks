...
1. `admission webhook "neuvector-validating-admission-webhook.neuvector.svc" denied the request:` These alerts can be seen also on `aks-neuvector-<env>` slack channels
